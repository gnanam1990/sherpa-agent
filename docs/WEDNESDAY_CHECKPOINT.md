...
Sherpa Agent is a smart-contract-backed spend manager for autonomous AI
...
- SDK test output: `pnpm --filter @sherpa-agent/guardrails test`
- Demo agent dry-run: `pnpm --filter @sherpa-agent/demo-agent start -- --dry-run`
- Dashboard preview: `pnpm --filter @sherpa-agent/dashboard dev`
...
- Prototype: `https://sherpa-agent-j3x8jgrop-gnanam1990s-projects.vercel.app`
